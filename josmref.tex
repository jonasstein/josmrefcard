...
Nachdem Sun Java 6 (auf Version achten!) installiert ist. lädt man JOSM als eine .jar Datei herunter und startet sie
...
\item[\Icon{validator.png} validator] Prüft Karte auf logische Unstimmigkeiten (Achtung: Oft  Fehlalarme!) 
...
\subsection*{Bilder georeferenzieren} Ein Foto kann Geoinformationen (Ort der Aufnahme) enthalten. 
Bei Digitalkameras ohne GPS-Empfänger wird ein der gleichzeitig mit GPS aufgezeichnete Track nachträglich mit 
den Fotos kombiniert. \\
